...
//extends Applet implements MouseListener, MouseMotionListener, Runnable, ActionListener, ItemListener, WindowListener
{
...
//        wPawnImage   = getImage(getCodeBase(), "wp.gif");
//                       tracker.addImage(wPawnImage, 0);
//        wKnightImage = getImage(getCodeBase(), "wn.gif");
//                       tracker.addImage(wKnightImage, 0);
//        wBishopImage = getImage(getCodeBase(), "wb.gif");
//                       tracker.addImage(wBishopImage, 0);
//        wRookImage   = getImage(getCodeBase(), "wr.gif");
//                       tracker.addImage(wRookImage, 0);
//        wQueenImage  = getImage(getCodeBase(), "wq.gif");
//                       tracker.addImage(wQueenImage, 0);
//        wKingImage   = getImage(getCodeBase(), "wk.gif");
//                       tracker.addImage(wKingImage, 0);
//        bPawnImage   = getImage(getCodeBase(), "bp.gif");
//                       tracker.addImage(bPawnImage, 0);
//        bKnightImage = getImage(getCodeBase(), "bn.gif");
//                       tracker.addImage(bKnightImage, 0);
//        bBishopImage = getImage(getCodeBase(), "bb.gif");
//                       tracker.addImage(bBishopImage, 0);
//        bRookImage   = getImage(getCodeBase(), "br.gif");
//                       tracker.addImage(bRookImage, 0);
//        bQueenImage  = getImage(getCodeBase(), "bq.gif");
//                       tracker.addImage(bQueenImage, 0);
//        bKingImage   = getImage(getCodeBase(), "bk.gif");
